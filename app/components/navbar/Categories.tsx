...
export const categories = [
  ...
  { label: "Countryside", icon: TbMountain, description: "This property in counrtyside" },
  ...
  { label: "Skiing", icon: FaSkiing, description: "This property has skiing activites" },
  ...
  { label: "Desert", icon: GiCactus, description: "This property is in desest" },
  { label: "Barns", icon: GiBarn, description: "This property is in Barns" },
  { label: "Lux", icon: IoDiamond, description: "This property in Luxuoris" },
];
